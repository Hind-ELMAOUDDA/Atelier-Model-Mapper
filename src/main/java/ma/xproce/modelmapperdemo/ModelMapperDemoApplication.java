    ...
    CommandLineRunner start(){
        return args -> {
            List<Customer> customers = List.of(
                    Customer.builder().id(1L).name("EL MAOUDDA Hind").email("hind@gmail.com").password("qwerty").build(),
                    Customer.builder().id(2L).name("AIT ALI Assia").email("assia@gmail.com").password("azerty").build(),
                    Customer.builder().id(3L).name("EL MAOUDDA Meryem").email("meryem@gmail.com").password("qwaz").build()
            );
